...
import { getAiLaunchCommand } from '../utils/aiProviders';
...
export const TerminalPane = memo(function TerminalPane({
  ...
  const handleOutputChunk = useCallback((chunk) => {
    ...
    setViewModeNotice('Interactive CLI prompt detected. Conversation stays active - open terminal panel if you need to answer it.');
  }, []);
            ...
            <div className={`desktop-terminal-stack${isTerminalPanelOpen ? ' terminal-panel-open' : ''}`}>
              <div className="desktop-conversation-surface">
                <DesktopConversationView
                  ...
                  showTerminalMirror={isNoticePersistent}
                />
              </div>
