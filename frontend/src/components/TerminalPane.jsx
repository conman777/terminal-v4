...
import { getAiCapabilities, getAiDisplayLabel, getAiInitialCommand } from '../utils/aiProviders';
...
export const TerminalPane = memo(function TerminalPane({
  ...
  const currentAiLabel = getAiDisplayLabel(currentAiType) || 'Assistant';
  const launchCommand = getAiInitialCommand(currentAiType);
