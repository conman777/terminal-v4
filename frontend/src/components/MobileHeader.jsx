      ...
      >
        <div className="mobile-header-top-row">
          ...
          {showInlineViewTabs ? (
            ...
            <span className="mobile-header-title">{isPreviewView ? 'Preview' : 'Terminal'}</span>
          )}

          <div className="mobile-header-actions-right">
            {/* Chat toggle - visible when not in preview view */}
            {!isPreviewView && (
              <button
                type="button"
            ...
            {/* Preview toggle is hidden while already in preview view */}
            {!isPreviewView && (
              <button
