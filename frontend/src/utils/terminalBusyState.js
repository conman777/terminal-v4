...
function getLastVisibleLine(value) {
  const lines = value
    .split('\n')
...
export function outputIndicatesTerminalIdle(output) {
...
export function cliEventIndicatesTerminalIdle(event) {
  return event?.type === 'assistant_turn' || event?.type === 'prompt_required';
}
